...
- ajout de `docs/development/PROJECT_STRUCTURE.md` ;
...
La documentation détaillée est dans `docs/security/IDENTITY_SSO_SECRETS_V2120.md` et `docs/history/validations/VALIDATION_V2120.md`.
