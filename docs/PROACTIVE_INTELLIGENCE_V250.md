...
Le type de job `proactive_scan` est supporté par le worker Redis. La planification calendaire automatique reste `partial` en v2.5 et sera reliée au scheduler Enterprise ultérieurement.
