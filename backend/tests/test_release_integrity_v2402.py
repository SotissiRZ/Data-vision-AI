...
def make_archive(tmp_path: Path, *, extra: bool = False, tamper: bool = False) -> Path:
    root = "datavision-ai-v2.40.2-complet"
    payload = b"2.40.2\n"
    manifest = {
