...
class Settings(BaseSettings):
    ...
    first_run_setup_mode: str = "local"  # local | disabled
    demo_account_enabled: bool = True
    demo_account_email: str = "demo@datavision.local"
    demo_account_password: str = "DataVision8!"
    demo_account_display_name: str = "Utilisateur Démo"
    demo_account_organization: str = "DataVision Démo"
    ...
    password_scrypt_maxmem_mb: int = 256
